PUMP_SELECTOR.Skin = PUMP_SELECTOR.Skin || function (parameters)  {
            ...
            if(f.name.indexOf(".coord") > -1) {
                ...
                tmp.onload = function() {
                    ...
                    if(f.name.indexOf("speed") > -1)  {
                        ...
                        _this.BASE.Objs["SPEED"+PUMP_SELECTOR.Globals.Looper.Speed].visible = false;
    ...
    this.DrawIDName	   = function(ctx, x, y, name)	{
    	for(var i=0;i<name.length;i++)	
    		if(name[i] in _this.BASE) ctx.drawImage(_this.BASE[name[i]] ,x+i*10,y  ,10,12);
    };
